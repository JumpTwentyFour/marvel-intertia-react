...
const CharacterCard = (props: CharacterType): JSX.Element => {
  ...
  return (
    <div className='card col-span-6 sm:col-span-3 md:col-span-4 mb-10 bg-blue shadow-4xl hover:shadow-3xl flex flex-col'>
      <div className='card__image w-full relative overflow-hidden flex items-center content-center'>
        <img src={characterImageUrl} alt={props.name} className='w-full absolute' />
      </div>
