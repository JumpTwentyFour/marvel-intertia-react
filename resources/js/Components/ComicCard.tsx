...
const ComicCard = (props: ComicType): JSX.Element => {
  ...
  const comicImageUrl = marvelImageUrl(thumbnail.path, thumbnail.extension)
  return (
    <div
      data-cy='comic-card'
    ...
    >
      ...
      <div className='card__details flex flex-col p-5 md:p-8 lg:p-10'>
        <h3 className='card__title text-3xl font-semibold' data-cy='comic-card-title'>{title}</h3>
